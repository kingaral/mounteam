      ...
      <div class="row">
        <div class="col-lg-12 p-5 rounded shadow-sm mb-5" style="background-color: white; opacity: 0.96">
          <div class="table-responsive">
            ...
            <a href="admin_add_trip.php"><button  type="button" class="btn btn-success">Добавить поездку</button></a>;
          </div>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <a href="db/admin_trips_delete.php?id=<?=$_GET['id']?>"><button type="button" class="btn btn-primary">Да</button>
            </div>
          </div>
        </div>
      </div>
